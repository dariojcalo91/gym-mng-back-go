...
const (
	AuthService_Login_FullMethodName  = "/gym.AuthService/Login"
	AuthService_Logout_FullMethodName = "/gym.AuthService/Logout"
)
...
//
// Access service (Transient actions)
...
const (
	UserService_RegisterUser_FullMethodName   = "/gym.UserService/RegisterUser"
	UserService_GetUserProfile_FullMethodName = "/gym.UserService/GetUserProfile"
)
...
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
//
// Identity service (Entity management)
...
func (c *userServiceClient) GetUserProfile(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
func (UnimplementedUserServiceServer) GetUserProfile(context.Context, *UserRequest) (*User, error) {
